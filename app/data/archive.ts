...
export const items: ArchiveItem[] = [
  ...
  },
  {
    ...
    media: [
      ...
      { type: 'image', src: '/photo/yoga/yoga3.jpg', alt: 'Morning practice' },
      { type: 'image', src: '/photo/yoga/yoga5.jpg', alt: 'Candle ceremony' },
      { type: 'image', src: '/photo/yoga/yoga9.jpg', alt: 'Cooking in the ashram kitchen' },
      { type: 'image', src: '/photo/yoga/yoga7.jpg', alt: 'Street food in India' },
      { type: 'image', src: '/photo/yoga/yoga8.jpg', alt: 'Amber Fort, Jaipur' },
      { type: 'image', src: '/photo/yoga/yoga10.jpg', alt: 'Langurs' },
      { type: 'image', src: '/photo/yoga/yoga4.jpg', alt: 'Tree pose in the mountains' },
      { type: 'image', src: '/photo/yoga/yoga11.jpg', alt: 'Practice at home' },
    ],
